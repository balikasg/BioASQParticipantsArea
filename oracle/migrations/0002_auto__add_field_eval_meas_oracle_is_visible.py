...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'eval_meas_oracle.is_visible'
        db.add_column('oracle_eval_meas_oracle', 'is_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'eval_meas_oracle.is_visible'
        db.delete_column('oracle_eval_meas_oracle', 'is_visible')
