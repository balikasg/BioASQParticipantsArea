...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'eval_measi_oracle_1bb'
        db.create_table('oracle_eval_measi_oracle_1bb', (
            ...
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 23, 0, 0))),
            ('is_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('oracle', ['eval_measi_oracle_1bb'])


    def backwards(self, orm):
        # Deleting model 'eval_measi_oracle_1bb'
        db.delete_table('oracle_eval_measi_oracle_1bb')
    ...
    models = {
        ...
        'oracle.eval_meas_oracle': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
        ...
        'oracle.eval_measi_oracle_1bb': {
            'Meta': {'object_name': 'eval_measi_oracle_1bb'},
